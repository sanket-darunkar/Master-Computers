 ...
 * Student Exam Form    : Exam Form Submitted | Exam Form Pending
 * Legacy student statuses (kept for backward-compat): ACTIVE | INACTIVE | COMPLETED | DROPPED
 */
export default function StatusBadge({ status }) {
  const map = {
    ...
    // Exam Form
    'Exam Form Submitted' : { label: 'Exam Form Submitted',  bg: '#dcfce7', text: '#15803d', border: '#bbf7d0' },
    'Exam Form Pending'   : { label: 'Exam Form Pending',    bg: '#fef9c3', text: '#a16207', border: '#fef08a' },
    // Legacy student statuses (backward compat)
